...
function main()
{
    ...
    {
        var id = faces[i];
        var C0 = new THREE.Color().setHex( '0x' + GetColor(scalars[id[0]]).getHexString() );
        var C1 = new THREE.Color().setHex( '0x' + GetColor(scalars[id[1]]).getHexString() );
        var C2 = new THREE.Color().setHex( '0x' + GetColor(scalars[id[2]]).getHexString() );
